...
namespace ASL
{
    ...
    public static class ASLHelper
    {
        ...
        {
            SendSpawnPrimitive(_type, _position, _rotation, _parentID, _instantiatedGameObjectClassName, _instantiatedGameObjectFunctionName);
        }
        ...
        {
            SendSpawnPrimitive(_type, _position, _rotation, _parentID, _instantiatedGameObjectClassName, _instantiatedGameObjectFunctionName, _claimRecoveryClassName, _claimRecoveryFunctionName);
        }
        ...
        /// <see cref="ASLObject.SendFloats(float[])"/> function. This parameter is optional. If you use this parameter you must also provide _sendFloatFunctionName</param>
        /// <param name="_sendFloatFunctionName">This is the name of the function that you want to be executed whenever you use the <see cref="ASLObject.SendFloats(float[])"/> function.
        ...
        static public void InstanitateASLObject(string _prefabName, Vector3 _position, Quaternion _rotation, string _parentID,
            ...
            string _instantiatedGameObjectFunctionName)
        {
            SendSpawnPrefab(_prefabName, _position, _rotation, _parentID, _instantiatedGameObjectClassName, _instantiatedGameObjectFunctionName);
        }
        ...
        static public void InstanitateASLObject(string _prefabName, Vector3 _position, Quaternion _rotation, string _parentID,
            ...
            string _claimRecoveryFunctionName = "")
        {
            SendSpawnPrefab(_prefabName, _position, _rotation, _parentID, _instantiatedGameObjectClassName, _instantiatedGameObjectFunctionName, _claimRecoveryClassName, _claimRecoveryFunctionName);
        }
        ...
        private static void SendSpawnPrimitive
            (PrimitiveType _type, Vector3 _position, Quaternion _rotation, string _parentID = "", string _instantiatedGameObjectClassName = "", string _instantiatedGameObjectFunctionName = "", 
