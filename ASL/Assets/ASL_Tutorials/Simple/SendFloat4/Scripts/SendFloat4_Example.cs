...
namespace SimpleDemos
{
    ...
    public class SendFloat4_Example : MonoBehaviour
    {
        ...
        * https://uwb-arsandbox.github.io/ASL/ASLDocumentation/Help/html/5a174bc7-f1fe-c49a-b81d-4ad397ffb286.htm Position*/
        ...
        /// <summary>What I want to do with the float values passed around for this object. By using a case statement
        ...
        public static void MyFloatFunction(float[] _myFloats)
        {
            ...
            switch (_myFloats[3])
            {
                ...
                case 4: //Sent random values
                    ...
                    break;
                default:
                    Debug.Log("This example does not do anything for m_MyFloats[3] above 4");
                    break;
            }
        }
    }
