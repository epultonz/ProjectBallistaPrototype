...
namespace Mps
{
    public partial class Mp3_TheWorld : MonoBehaviour
    {

        public Mp3_UILineSegment AimingLine;
        public Mp3_UILineSegment BigLine;
        public Mp3_Plane Barrier;
        public GameObject travelingBall;

        public Mp3_SliderWithEcho IntervalControl = null;
        public Mp3_SliderWithEcho SpeedControl = null;
        public Mp3_SliderWithEcho DeathControl = null;
        ...
        void Update()
        {
            ...
            if (mSinceLastGenerated >= mGenerateInterval)
            {
                ...
                Mp3_TravelingBall b = g.GetComponent<Mp3_TravelingBall>();
                b.Initialize(this);
        ...
        public void SetLocalBallSpeed(float[] s)
        {
            mSpeed = s[0];
        ...
        public void SetLocalBallInterval(float[] f)
        {
        ...
        public void SetLocalAliveTime(float[] l)
        {
            mAliveTime = l[0];
        ...
        public Mp3_LineSegment GetAimLine() { return AimingLine; }
    }
}